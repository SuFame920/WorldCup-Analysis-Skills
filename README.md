...
> **分项** = 每个玩法命中一档即算中(分母=分项数)　**逐档** = 每个预测档单独算(分母=所有预测档数)。**命中的预测档加粗**,未加粗即未中。胜平负 / 半全场均以"vs 左侧球队"为视角(胜=左队胜);让球列 `±N+赛果` = 左队让(−)/ 受让(+)N 球后的左队赛果,净胜恰为 N 即"平"(走盘退款)。
...
**命中率｜分项 15/30 = 50%　·　逐档 15/58 ≈ 26%**　·　🌟 瑞士 4/5(比分 2-1 精确命中!+让平 push+平胜) · ⚠️ 南非-韩国仅 1/5(信息失误→全错向)
