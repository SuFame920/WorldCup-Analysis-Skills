...
> 表中**加粗**=该预测档命中。**整体** = 所有预测档的逐档聚合(分母=所有预测档总数)。5 条玩法曲线 = 各玩法逐档命中率(分母=该玩法预测档数,比分/大小球预测个数多不会抬高命中率)。让球列 `±N` = 左队让(−)/受让(+)N 球后的赛果,净胜恰为 N 即"让平"。**累计整体逐档 91/288 ≈ 32% (30 场已结算)**。

### 🏷️ v1.7 · 2026-06-27(J/K/L 组 MD3 · 6 场) 🔜 待结算

| 比赛 | 赛果 | 胜平负 | 让球 | 比分 | 大小球 | 半全场 |
|---|---|---|---|---|---|---|
| 克罗地亚 vs 加纳 | — | 胜 / 平 | -1平 / -1负 | 1-0 / 0-0 / 1-1 | 1球 / 0球 | 平胜 / 平平 |
