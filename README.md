...
> **分项** = 每个玩法命中一档即算中(分母=分项数)　**逐档** = 每个预测档单独算(分母=所有预测档数)。**命中的预测档加粗**,未加粗即未中。胜平负 / 半全场均以"vs 左侧球队"为视角(胜=左队胜);让球列 `±N` + 赛果 = 左队让(−)/ 受让(+)N 球后的左队赛果,净胜恰为 N 即"平"(走盘)。**累计命中率｜分项 84/150 = 56%　·　逐档 84/281 ≈ 30%　(24 场已结算)**
...
| 土耳其 vs 美国 | **2-2** | **平** / 胜 | **+1胜** | 1-1 / 2-1 土 | 2球 / 3球 | 平平 / 平胜 |

**命中率｜v1.5 分项 17/30 = 57%　·　逐档 17/57 ≈ 30%**　·　🌟 让球 **6/6 全中**(含4走盘!) — 铁律级增量 · ⭐ 日-瑞全次选对冲命中(4/5) · ⭐ 库拉索 0-2 科特迪瓦(4/5,比分精确!) · 三种MD3亚型:解放效应/表演赛/绞杀死锁
