...
> **分项** = 每个玩法命中一档即算中(分母=分项数)　**逐档** = 每个预测档单独算(分母=所有预测档数)。下表只给命中项打 ✅,留白即未中。　⚖️=让球走盘(净胜 1,退款):押中走盘记 ✅,押过盘却走盘记 ⚖️(不计命中)。

### 🏷️ v1.2 · 2026-06-23(K/L 组 4 场)

| 比赛 | 真实结果 | 胜平负 | 让球 | 比分 | 大小球 | 半全场 |
|---|---|---|---|---|---|---|
| 哥伦比亚 vs 刚果(金) | **1-0** | 哥伦比亚胜 ✅ | 哥让1 走盘 ✅ | 1-0 ✅ / 2-0 | 2球 / 1球 ✅ | 平胜 ✅ |
| 巴拿马 vs 克罗地亚 | **0-1** | 克罗地亚胜 ✅ | 克让1 胜 ⚖️ | 2-0 / 1-0 ✅ | 2球 / 1球 ✅ | 负负 / 平负 ✅ |
| 葡萄牙 vs 乌兹别克斯坦 | **5-0** | 葡萄牙胜 ✅ | 葡让1 胜 ✅ | 2-0 / 3-0 / 2-1 | 2球 / 3球 | 平胜 |
| 英格兰 vs 加纳 | **0-0** | 英格兰胜 | 英让1 胜 | 2-1 / 2-0 / 3-0 | 3球 / 2球 | 胜胜 |
