...
> **分项** = 每个玩法命中一档即算中(分母=分项数)　**逐档** = 每个预测档单独算(分母=所有预测档数)。**命中的预测档加粗**,未加粗即未中。胜平负 / 半全场均以"vs 左侧球队"为视角(胜=左队胜);让球列 `±N+赛果` = 左队让(−)/ 受让(+)N 球后的左队赛果,净胜恰为 N 即"平"(走盘退款)。**累计命中率｜分项 85/150 = 57%　·　逐档 85/281 ≈ 30%　(24 场已结算)**
